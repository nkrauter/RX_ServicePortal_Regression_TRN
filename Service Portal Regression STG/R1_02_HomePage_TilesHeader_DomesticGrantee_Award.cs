...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s for the attribute 'InnerText' to equal the specified value 'Hi, Rachel Green!'. Associated repository item: 'Login1.HiRachelGreen'", repo.Login1.HiRachelGreenInfo, new RecordItemIndex(21));
            repo.Login1.HiRachelGreenInfo.WaitForAttributeEqual(5000, "InnerText", "Hi, Rachel Green!");
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s for the attribute 'InnerText' to equal the specified value 'Hi, Rachel Green!'. Associated repository item: 'Login1.HiRachelGreen'", repo.Login1.HiRachelGreenInfo, new RecordItemIndex(31));
            repo.Login1.HiRachelGreenInfo.WaitForAttributeEqual(5000, "InnerText", "Hi, Rachel Green!");
